...
<head>
    ...
    <?php endif; ?>
<meta name="google-site-verification" content="3-OAoixMF6FaG6w-PwsVFWbA-pPDvrH99WI0DEjVDfY" />
<meta name="y_key" content="e48fac86365ea523" />
<meta name="msvalidate.01" content="A006AD751FC5E093C8764778424CC9AB" />
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-36957301-1']);
...
<script src="<?php bloginfo('template_url'); ?>/js/jquery.example.min.js" type="text/javascript"></script>
<script type="text/javascript" >
...
<div id="wrapper">
	<div id="header">
        ...
        <ul id="banner_links">
            ...
            <li><a href="<?php echo get_permalink(11); ?>" title="Client List"><?php echo get_the_title(11) ?></a></li>
    	...
    	<form method="post" action="http://www.aweber.com/scripts/addlead.pl" id="signup_form">
            ...
            <input type="hidden" name="listname" value="methodspeaking" />
            ...
            <input type="hidden" name="meta_adtracking" value="MethodSpeakingMain" />
            <input type="hidden" name="meta_message" value="1" />
            <input type="hidden" name="meta_required" value="email" />
            <input type="hidden" name="meta_forward_vars" value="" />
            <input type="hidden" name="meta_tooltip" value="" />
        	<h2>A Free Public Speaking Tip Every Tuesday!</h2>
            <p>Upgrade Your Tool-Box Every Single Week - No-Spam</p>
